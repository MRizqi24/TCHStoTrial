...
@section('content')
    <div class="card mt-5 ">
        <div class="card-body">
                ...
                <div class="form-row align-items-center">
                    <div class="col-sm-2 my-1">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="itemcode_input"type="text" value=""
                                id="itemcode_input">
                        </div>
                    </div>
                    <div class="col-sm-3 my-1">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="partname_input" type="text" value=""
                                id="partname_input" readonly>
                        </div>
                    </div>
                    <div class="col-sm-2 my-1">
                        <div class="form-group">
            ...
            <div class="card mt-5">
                <div class="card-body">
                    {{-- Start form import data ke master item --}}
                    ...
                    {{-- End form import data ke master item --}}
